...
* [from Data to Viz](https://www.data-to-viz.com/#ridgeline)
...
* [Data Visualization em R](https://www.tatvic.com/blog/7-visualizations-learn-r/)
* [The R Graph Gallery](https://www.r-graph-gallery.com/)
* [**Patchwork** - "Ridiculamente Simples combinar figuras do ggplot"](https://github.com/thomasp85/patchwork)
* [**Alluvial** diagram ou Sankey no Kaggle](https://www.kaggle.com/kailex/talkingdata-eda-and-class-imbalance)
...
* [Gráficos incluindo **barras de erro**](https://pt.stackoverflow.com/questions/200244/gr%C3%A1fico-de-perfis-de-m%C3%A9dia-incluindo-as-barras-de-erro)
* [GGplot com **figuras** aleatorias](http://giorasimchoni.com/2018/01/03/2018-01-03-congratulations-it-s-a-geom/)
* [5 Melhores extensões para o ggplot2](https://www.ibpad.com.br/blog/cinco-melhores-extensoes-ao-ggplot2/)
* [Great Visualizations in R - Kaggle happiness 2017](https://www.kaggle.com/javadzabihi/happiness-2017-visualization-prediction/notebook)
* [Curso ggplot2](http://marcusnunes.me/post/curso-ggplot2/)
* [Gráfico e tabela descritiva na mesma imagem](http://www.sthda.com/english/articles/24-ggpubr-publication-ready-plots/81-ggplot2-easy-way-to-mix-multiple-graphs-on-the-same-page/)
* [Seja incrível em ggplot2: um guia prático para ser altamente eficaz - software R e visualização de dados](http://www.sthda.com/english/wiki/be-awesome-in-ggplot2-a-practical-guide-to-be-highly-effective-r-software-and-data-visualization)
* [5 melhores extensões de ggplot](https://www.ibpad.com.br/blog/cinco-melhores-extensoes-ao-ggplot2/)
* [Diagrama de Venn com ggplot2](https://scriptsandstatistics.wordpress.com/2018/04/26/how-to-plot-venn-diagrams-using-r-ggplot2-and-ggforce/)
* [Infographic-style charts using the R waffle package](https://www.r-bloggers.com/infographic-style-charts-using-the-r-waffle-package/amp/)
* [Criando **Slopegraphs** com R](https://datascienceplus.com/creating-slopegraphs-with-r/)
* [**Beeswarms** em vez de histogramas](https://aghaynes.wordpress.com/2018/06/28/beeswarms-instead-of-histograms/)
* [Por um mundo maior que o gráfico de pizza](https://rpubs.com/StevenDuttRoss/treemap)
* [[ggplot2] Welcome **viridis** !](https://rtask.thinkr.fr/blog/ggplot2-welcome-viridis/)
* [Plotting **Likert**-Scales (net stacked distributions) with ggplot](https://strengejacke.wordpress.com/2013/07/17/plotting-likert-scales-net-stacked-distributions-with-ggplot-rstats/)
* [GGPLOT2 add **logo**](http://www.danielphadley.com/ggplot-logo/)
* [**Sankey** Diagram for the 2018 FIFA World Cup Forecast](https://www.r-bloggers.com/sankey-diagram-for-the-2018-fifa-world-cup-forecast/amp/)
...
* [R colors - **cores** legais para R](http://www.stat.columbia.edu/~tzheng/files/Rcolor.pdf)
* [**ggrepel** - legendas legais](https://cran.r-project.org/web/packages/ggrepel/vignettes/ggrepel.html)
* [**Styling** ggplot2 Graphics - Paleta de cores e text group](https://www.jumpingrivers.com/blog/styling-ggplot2-r-graphics/)
* [Exploring ggplot2 **boxplots** – Defining limits and adjusting style](https://www.r-bloggers.com/exploring-ggplot2-boxplots-defining-limits-and-adjusting-style/amp/)
* [beautiful graphics ggplot2](https://rstudio-pubs-static.s3.amazonaws.com/228019_f0c39e05758a4a51b435b19dbd321c23.html#2_plot_two_variables_-x__y:_both_continuous_or_discrete)
* [**Paleta** de cores (cores diferenciadas - muitas)](https://stackoverflow.com/questions/9563711/r-color-palettes-for-many-data-classes)
* [Gráfico de **Sankey**](https://www.r-graph-gallery.com/sankey-diagram/)
* [Facets for ggplot in R](https://www.datacamp.com/community/tutorials/facets-ggplot-r)
* [THE R GRAPH GALLERY - CONNECTION MAP](https://www.r-graph-gallery.com/connection-map/)
...
* [Animate your data wrangling](https://luisdva.github.io/rstats/animate-untangle/)
...
* [Analysing cryptocurrency market in r - API criptomoedas](https://datascienceplus.com/analysing-cryptocurrency-market-in-r/)
* [Coletando dados do Facebook](http://www.dadosaleatorios.com.br/2016/03/coletando-dados-do-facebook.html?m=1)
* [Workshop sobre AIP do twitter facebook  e youtube](https://static1.squarespace.com/static/559085e9e4b0942571880993/t/57e1fe2b37c58156a98f8f06/1474428463437/R+Workshop-Social-Media-API.pdf)
...
* [Você sabe (de verdade) o que é big data?](https://br.udacity.com/blog/post/o-que-e-big-data)
* [Slides - IA e o Futuro do Trabalho (Flavio Abdenur / SLQ)](https://www.slideshare.net/FlavioAbdenur/ia-e-o-futuro-do-trabalho-flavio-abdenur-slq)
...
* [Fellipe Gomes](gomesfellipe.github.io)
* [SimplyStats](https://simplystatistics.org/post/)
* [Business - Science](http://www.business-science.io)
* [RDojo](https://therdojo.wordpress.com/)
* [Dr. Shirin Glander](https://shirinsplayground.netlify.com/)
* [Vooo – Insights - Data Science. Python. Gestão.](https://www.vooo.pro/insights/)
* [STATWORX Blog](https://www.statworx.com/at/blog/)
...
* [Alinhando Comentários](https://www.r-bloggers.com/align-assign-rstudio-addin-to-align-assignment-operators/)
* [Auto format r code in Rstudio e tidy_eval ](https://stackoverflow.com/questions/15703553/auto-format-r-code-in-rstudio/34856235#34856235)
* [styler - Um formatador de código-fonte não invasivo para R](https://lorenzwalthert.github.io/stylerpost/)
...
* [The steps of a Kaggle project - Bruna Wundervald](https://www.datameister.com.br/inicio-1/criando-gr%C3%A1ficos-sem-programa%C3%A7%C3%A3o-no-rstudio-com-equisse)
...
* [GGPLOT2](http://marcusnunes.me/post/curso-ggplot2/)
* [Introduction to ggplot2—the grammar](https://www.datasciencecentral.com/profiles/blogs/introduction-to-ggplot2-the-grammar)
* [STHDA super  post GGPLOT2](http://www.sthda.com/english/wiki/be-awesome-in-ggplot2-a-practical-guide-to-be-highly-effective-r-software-and-data-visualization)
* [RMarkdown](https://github.com/lhmet/adar-ufsm/blob/master/Rmarkdown.md)
* [Curso do Google Machine Learning](https://developers.google.com/machine-learning/crash-course/)  
* [100 Free Tutorials for Learning R](https://www.listendata.com/p/r-programming-tutorials.html?m=1)
* [Ciencia de dados com R - conceitos básicos](https://cdr.ibpad.com.br/conceitos-basicos.html)
* [Code for Workshop: Introduction to Machine Learning with R](https://www.r-bloggers.com/code-for-workshop-introduction-to-machine-learning-with-r/)
* [Aulas USP | Inteligência Artificial em saúde: o uso de machine learning](https://www.youtube.com/playlist?list=PLAudUnJeNg4tvUFZ8tXQDoAkFAASQzOHm&app=desktop)
* [Data Science and Big Data Analytics:
Making Data-Driven Decisions - MIT](https://bigdataanalytics.mit.edu/)
* [Teaching R to New Users - From tapply to the Tidyverse](https://simplystatistics.org/2018/07/12/use-r-keynote-2018/)
* [Learning from Data - Machine Learning course - recorded at a live broadcast from Caltech](https://work.caltech.edu/telecourse.html)
* [stanford.edu - Machine Learning](https://stanford.edu/~shervine/teaching/cs-229.html)
* [USGS - R Training Curriculum](https://owi.usgs.gov/R/training-curriculum/)
* [FOUNDATIONS OF MACHINE LEARNING - Bloomberg ML EDU](https://bloomberg.github.io/foml/#home)
...
* [Guia de introdução em Portugues](https://www.elastic.co/webinars/elasticsearch-introducao?blade=facebook&hulk=cpc)
* [Elasticsearch for Dummies](https://www.datasciencecentral.com/profiles/blogs/elasticsearch-for-dummies)  
...
* [Standard deviation vs Standard error](https://datascienceplus.com/standard-deviation-vs-standard-error/)

## Testes estatísticos

* [Pacote para interpretar testes estatísticos](https://neuropsychology.github.io/psycho.R//2018/07/20/analyze_anova.html)
* [Rules of thumb on magnitudes of effect sizes](http://imaging.mrc-cbu.cam.ac.uk/statswiki/FAQ/effectSize)
...
* [emo(ji) is to make it very easy to insert emoji into RMarkdown](https://github.com/hadley/emo)
* [How to self-publish a book](https://www.r-bloggers.com/how-to-self-publish-a-book/amp/)
* [SoFIFA webcrawler and Machine Learning prediction](https://github.com/DiogoDantas/SoFIFA)
* [Artigo sobre historia do R](https://rss.onlinelibrary.wiley.com/doi/10.1111/j.1740-9713.2018.01169.x)
* [Operadores de Python e muito mais para R com Roperators](https://cran.r-project.org/web/packages/roperators/vignettes/nicer_roperators_v1_1_0.html)
* [O Índice Big Mac da Economist é calculado com R](https://www.r-bloggers.com/the-economists-big-mac-index-is-calculated-with-r/amp/)
* [Agendador de tarefas](https://github.com/bnosac/taskscheduleR)
* [DYSPLAYR - Using R to Create Free Online Dashboards](https://www.displayr.com/using-r-to-create-free-online-dashboards/)
...
* ["R"eflexões um pouco de história e experiencias com R - Paulo Justiniano](https://www.youtube.com/watch?feature=youtu.be&v=fnGvDEkjZy0&app=desktop)
* [BETS - Brazilian Economic Times Series ](http://slides.com/johnazevedo/deck-5/fullscreen)
* [Introdução à Ciência de Dados com o R - UserR!](https://dataunirio.github.io/Palestra_Visual_de_Dados_com_R/#1)
* [A Era do Big Data: Como você e a sua empresa estão encarando essas mudanças?](https://youtu.be/QtlUBCarh1Y)
* [Apresentação Thiago - NMEC](http://rpubs.com/thop/r-aws)
* [prR R Intro](http://www.pqr-project.org/R-intro.html)  

# Extras sobre data science  

* [Top 10 TED Talks about data science](https://www.kdnuggets.com/2018/01/top-10-ted-talks-data-scientists-machine-learning.html)
* [18 livros que valem mais que um doutorado em data science](http://cio.com.br/carreira/2018/01/04/dezoito-livros-que-valem-mais-que-um-doutorado-em-data-science/)
...
* [What frustrates Data Scientists in Machine Learning projects?](https://towardsdatascience.com/what-frustrates-data-scientists-in-machine-learning-projects-3398919a7c79)
* [R ou Python para Análise de Dados?](http://www.cienciaedados.com/r-ou-python-para-analise-de-dados/)
* [Diário de um Cientista de Dados no Booking.com](https://paulovasconcellos.com.br/di%C3%A1rio-de-um-cientista-de-dados-no-booking-com-121d02ebe10e)
* [Slides - IA e o Futuro do Trabalho (Flavio Abdenur / SLQ)](https://www.slideshare.net/FlavioAbdenur/ia-e-o-futuro-do-trabalho-flavio-abdenur-slq)
* [Entregando projetos de Machine Learning com Marvin-AI Parte 1](https://www.linkedin.com/pulse/entregando-projetos-de-machine-learning-com-marvin-ai-rafael-novello/)
* [THE R GRAPH GALLERY - ART FROM DATA](https://www.r-graph-gallery.com/portfolio/data-art/)
* [Avoid These 5 Common Mistakes If You Want To Ace Data Science](https://www.analyticsindiamag.com/avoid-these-5-common-mistakes-if-you-want-to-ace-data-science/)
...
* [Personalizando Projeto no GiHub](https://braziljs.org/blog/profissionalizando-seus-projetos-no-github-2/)

# Grafos

* [emstreeR - An R Package for Fast Computing Euclidean Minimum Spanning Trees](https://github.com/allanvc/emstreeR)
...
* [Interaction terms in regression models](https://cfss.uchicago.edu/persp013_interaction_terms.html#decision_trees)

# Livros  

* [Livro R Avançado do Hadley Wickham](https://adv-r.hadley.nz/index.html)
* [Deep Learning Book](http://deeplearningbook.com.br/)
* [Livro TextMining da Julia Silge](https://www.tidytextmining.com/)
* [Bibliografia datascience](http://datascienceacademy.com.br/blog/bibliografia-big-data-e-data-science/)
* [3 livros sobre machine learning em portugues](https://www.linkedin.com/pulse/3-livros-sobre-machine-learning-em-portugu%C3%AAs-para-se-um-silva-junior/)
* [The Elements of Statistical Learning Data Mining, Inference, and Prediction](https://web.stanford.edu/~hastie/Papers/ESLII.pdf)
* [Machine Learning for Text](https://rd.springer.com/book/10.1007/978-3-319-73531-3)
* [Mining of Massive Datasets](http://www.mmds.org/#book)
* [Forecasting and Machine Learning: Principles and Practice](https://otexts.org/fpp2/)
...
* [Data Science: Theories, Models, Algotirhms ans analytics](https://srdas.github.io/Papers/DSA_Book.pdf)
* [80+ Free Data Science Books](https://www.datasciencecentral.com/profiles/blogs/80-free-data-science-books)
* [Data Science Live Book](https://livebook.datascienceheroes.com/)
* [HANDBOOK - Summary and Analysis of Extension Program Evaluation in R](http://rcompanion.org/handbook/)
...
* [Flexible Imputation os Missing Data](https://stefvanbuuren.name/fimd/)

# Machine Learning

* [Plano de estudos em machine learning com conteúdos em português](https://github.com/italojs/awesome-machine-learning-portugues)
...
* [Introdução em profundidade ao aprendizado de máquina em 15 horas de vídeos especializados](https://www.r-bloggers.com/in-depth-introduction-to-machine-learning-in-15-hours-of-expert-videos/)
* [OneDrive com conteúdos de Machine Learning](https://drive.google.com/drive/folders/1XdWtd2rjz09hYRpeb7ie0enezH5VvNMU)
* [Curso do Google](https://developers.google.com/machine-learning/crash-course/)
* [Practical Machine Learning with R and Python – Part 1](https://gigadom.wordpress.com/2017/10/06/practical-machine-learning-with-r-and-python-part-1/)
* [mlr: Machine Learning in R](https://mlr-org.github.io/mlr/articles/mlr.html)
* [A visual introduction to machine learning par I](http://www.r2d3.us/visual-intro-to-machine-learning-part-1/)
* [A visual introduction to machine learning par II](http://www.r2d3.us/visual-intro-to-machine-learning-part-2/)
* [Dataaspirant  - Posts by Rahul Saxena - Blog legal sobre Machine Learning](http://dataaspirant.com/author/rahul-saxena/)
* [Grupos de Estudos de Machine Learning da USP](https://mlime.github.io/)
...
* [FOUNDATIONS OF MACHINE LEARNING - Bloomberg ML EDU](https://bloomberg.github.io/foml/#home)
* [Dicas e truques de aprendizado de máquina - MIT stanford.edu em PORTUGUES ](https://stanford.edu/~shervine/l/pt/teaching/cs-229/dicas-aprendizado-profundo)
* [Machine Learning Black Friday Dataset - Explicações rf, gbm, pca, ](https://www.datacamp.com/community/tutorials/ml-black-friday-dataset) 
...
* [UNDERSTAND EMPLOYEE CHURN USING H2O MACHINE LEARNING AND **LIME**](https://www.business-science.io/business/2018/06/25/lime-local-feature-interpretation.html)
* [INTERPRETABLE MACHINE LEARNING ALGORITHMS WITH **DALEX** AND **H2O**](https://www.business-science.io/business/2018/07/23/dalex-feature-interpretation.html)
* [**IML** AND **H2O**: MACHINE LEARNING MODEL INTERPRETABILITY AND FEATURE EXPLANATION](https://www.business-science.io/business/2018/08/13/iml-model-interpretability.html)
* [Efficient Machine Learning in H2O with R and Python, Part 1](http://www.dataversity.net/efficient-machine-learning-h2o-r-python-part-1/)
...
* [Hidden Markov Model example in r with the depmixS4 package](http://gradientdescending.com/hidden-markov-model-example-in-r-with-the-depmixs4-package/)
* [Bayesian Network Example with the bnlearn Package](https://www.r-bloggers.com/bayesian-network-example-with-the-bnlearn-package/amp/)
...
* [LM - Machine learning fundamentals (I): Cost functions and gradient descent](https://towardsdatascience.com/machine-learning-fundamentals-via-linear-regression-41a5d11f5220)
* [What Is A Decision Tree Algorithm?](https://medium.com/@SeattleDataGuy/what-is-a-decision-tree-algorithm-4531749d2a17)
* [Chapter 5: Random Forest Classifier](https://medium.com/machine-learning-101/chapter-5-random-forest-classifier-56dc7425c3e1)
* [Machine Learning for Humans, Part 4: Neural Networks & Deep Learning](https://medium.com/machine-learning-for-humans/neural-networks-deep-learning-cdad8aeae49b)
* [Introduction to Bayesian Thinking: from Bayes theorem to Bayes networks](https://towardsdatascience.com/will-you-become-a-zombie-if-a-99-accuracy-test-result-positive-3da371f5134)
...
* [Visualizando Resíduos](https://drsimonj.svbtle.com/visualising-residuals)
* [Linear Model Selection](https://uc-r.github.io/model_selection)
* [O LASSO](https://azul.netlify.com/2018/09/16/lasso/)
...
* [Seleção de modelos usando o pacote glmulti](http://www.metafor-project.org/doku.php/tips:model_selection_with_glmulti#model_selection)
* [Intuition behind Bias-Variance trade-off, Lasso and Ridge Regression](https://www.datasciencecentral.com/profiles/blogs/intuition-behind-bias-variance-trade-off-lasso-and-ridge)
* [15 TIPOS DE REGRESSÃO QUE VOCÊ DEVE SABER](https://www.listendata.com/2018/03/regression-analysis.html)
* [`summ` - Tools for summarizing and visualizing regression models](https://cran.r-project.org/web/packages/jtools/vignettes/summ.html)
* [Regularização: Ridge, Lasso e Elastic Net - DataCamp Tutorials](https://www.datacamp.com/community/tutorials/tutorial-ridge-lasso-elastic-net)
* [REGRESSÃO LOGÍSTICA: ASPECTOS COMPUTACIONAIS - COM TENSORFLOW](https://www.curso-r.com/blog/2018-11-18-logistica-comp/)
...
* [Illustrated Guide to ROC and AUC - Plot da curva ROC](https://www.r-bloggers.com/illustrated-guide-to-roc-and-auc/)
* [Machine Learning Evaluation Metrics in R](https://machinelearningmastery.com/machine-learning-evaluation-metrics-in-r/)
* [Plot da matriz de confusão](https://stats.stackexchange.com/questions/109079/confusion-between-caret-randomforest-predict-results-and-reported-model-perfor)
* [Gain Curve](https://topepo.github.io/caret/measuring-performance.html)
* [Gain Curve interpretation](https://stats.stackexchange.com/questions/279385/gain-curve-interpretation)
* [Confusion between caret randomForest predict() results and reported model performance](https://stats.stackexchange.com/questions/109079/confusion-between-caret-randomforest-predict-results-and-reported-model-perfor)
* [Introduction to modelplotr](https://www.r-bloggers.com/introduction-to-modelplotr/)
...
* [Tree-based Methods - lagunita.stanford.edu (Muito Bom)](https://lagunita.stanford.edu/c4x/HumanitiesScience/StatLearning/asset/trees.pdf)
...
* [Um tutorial completo sobre a modelagem baseada em Tree (Árvore) do Zero (em R & Python)](https://www.vooo.pro/insights/um-tutorial-completo-sobre-a-modelagem-baseada-em-tree-arvore-do-zero-em-r-python/)
* [BooST (Boosting Smooth Trees) a new Machine Learning Model for Partial Effect Estimation in Nonlinear Regressions](https://insightr.wordpress.com/2018/08/14/boost-boosting-smooth-trees-a-new-machine-learning-model-for-partial-effect-estimation-in-nonlinear-regressions/)
* [Tunning XGBOOST in R: Part I](https://insightr.wordpress.com/2018/05/17/tuning-xgboost-in-r-part-i/)
* [Tuning xgboost in R: Part II](https://insightr.wordpress.com/2018/07/28/tuning-xgboost-in-r-part-ii/)  
* [Parallel Gradient Boosting Decision Trees](http://zhanpengfang.github.io/418home.html)
* [Um guia de ponta a ponta para entender a matemática por trás do XGBoost](https://www.analyticsvidhya.com/blog/2018/09/an-end-to-end-guide-to-understand-the-math-behind-xgboost/)
* [User written splitting functions for RPART - cran.r-project.org](https://cran.r-project.org/web/packages/rpart/vignettes/usercode.pdf)
* [Tips for data science competitions - ALL XGBoost](https://www.slideshare.net/OwenZhang2/tips-for-data-science-competitions/14)
* [Mastering The New Generation of Gradient Boosting - CatBoost](https://www.kdnuggets.com/2018/11/mastering-new-generation-gradient-boosting.html)
* [PDF PUC RIO - Árvore de Decisão  ](https://www.maxwell.vrac.puc-rio.br/3710/3710_4.PDF)
* [Coding Regression trees in 150 lines of R code](https://www.statworx.com/de/blog/coding-regression-trees-in-150-lines-of-code/)
...
* [13 Great Articles About K-Nearest-Neighbors And Related Algorithms](https://www.datasciencecentral.com/profiles/blogs/13-great-articles-about-k-nearest-neighbors-and-related-algorithm)
...
* [Dicas de aprendizado não supervisionado - MIT stanford.edu em PORTUGUES](https://stanford.edu/~shervine/l/pt/teaching/cs-229/dicas-aprendizado-nao-supervisionado)
* [Self Organizing Maps in R | Kohonen Networks for Unsupervised and Supervised Maps](https://www.youtube.com/watch?v=wLu213JKfnQ)
* [Visualize K-Means Clustering on a Single Vector](http://jamesmarquezportfolio.com/visualize_k_means_clusters_on_a_single_vector.html)
* [Guia de iniciantes para aprender técnicas de redução de dimensão](https://www.analyticsvidhya.com/blog/2015/07/dimension-reduction-methods/)
...
* [Dimensionality Reduction Methods: PCA, t-SNE, SOM ](https://www.r-bloggers.com/dimensionality-reduction-methods-using-fifa-18-player-data/amp/)
* [Análise fatorial em R](http://wiki.icmc.usp.br/images/b/b5/Factanalysis.pdf)
* [Otimo TCC - ANÁLISE FATORIAL E UMA APLICAÇÃO EM PERFIL DE COMPRAS DE PEQUENOS VAREJISTAS](https://repositorio.ufu.br/bitstream/123456789/17883/3/An%C3%A1liseFatorialAplica%C3%A7%C3%A3o.pdf)
...
* [Interpretar os principais resultados para Análise de componentes principais - Minitab](https://support.minitab.com/pt-br/minitab/18/help-and-how-to/modeling-statistics/multivariate/how-to/principal-components/interpret-the-results/key-results/)
* [Dissecando Análise de Componentes Principais](https://ocefpaf.github.io/python4oceanographers/blog/2014/12/01/PCA/)
...
* [PCA vs Autoencoders for Dimensionality Reduction](https://www.r-bloggers.com/pca-vs-autoencoders-for-dimensionality-reduction/amp/)
* [Factoextra R Package: Easy Multivariate Data Analyses and Elegant Visualization](http://www.sthda.com/english/wiki/factoextra-r-package-easy-multivariate-data-analyses-and-elegant-visualization)
...
* [A Semi-Supervised Classification Algorithm using Markov Chain and Random Walk in R](https://www.datasciencecentral.com/profiles/blogs/a-semi-supervised-classification-algorithm-using-markov-chain-and)

## Resultados Apresentáveis

* [modelDown: um gerador de website para seus modelos preditivos](http://smarterpoland.pl/index.php/2018/06/modeldown-a-website-generator-for-your-predictive-models/)
...
* [Recording and Measuring Your Musical Progress with R](https://datascienceplus.com/recording-and-measuring-your-musical-progress-with-r/)
* [Introduction to the chorrrds package](https://r-music.rbind.io/posts/2018-08-19-chords-analysis-with-the-chorrrds-package/)
* [Rspotify: Access to Spotify API](https://github.com/tiagomendesdantas/Rspotify)

# Microsoft tools

* [Microsoft r open 3.5 está disponível](https://www.r-bloggers.com/microsoft-r-open-3-5-0-now-available/amp/)
* [Using Microsoft R Open with RStudio](https://www.r-bloggers.com/using-microsoft-r-open-with-rstudio/)
* [Creating and saving multiple plots to Powerpoint](https://www.johnmackintosh.com/2018-11-30-multiple-plots-to-powerpoint/)
* [Macro para Word para formatar todas as tabelas](https://datascienceplus.com/r-markdown-how-to-format-tables-and-figures-in-docx-files/)
* [Por que o R é melhor que o Excel?](http://blog.revolutionanalytics.com/2014/10/why-r-is-better-than-excel.html)
* [Dicas para analisar dados do Excel em R](https://blog.revolutionanalytics.com/2018/08/how-to-use-r-with-excel.html)
* [How To Use R With Excel](https://rpubs.com/acolumbus/how-to-use-r-with-excel)
* [BERT - Basic Excel R Toolkit](https://bert-toolkit.com/)

# Outliers e Missing

* [Anomaly Detection in R – The Tidy Way - Outliers??](https://datascienceplus.com/anomaly-detection-in-r-the-tidy-way/)
* [Spatial outliers detection in R?](https://gis.stackexchange.com/questions/219255/spatial-outliers-detection-in-r/270526#270526)
...
* [Z-test](http://www.dummies.com/education/math/statistics/z-testing-r/)
* [INFORMATION SECURITY: ANOMALY DETECTION AND THREAT HUNTING WITH ANOMALIZE](http://www.business-science.io/business/2018/06/10/infosec-anomalize-threat-hunting.html)
...
](http://www.business-science.io/business/2018/06/10/infosec-anomalize-threat-hunting.html)
* [Twitter Anomaly Detection](https://github.com/twitter/AnomalyDetection)
* [Z-Score: Definição, Fórmula e Cálculo](https://www.statisticshowto.datasciencecentral.com/probability-and-statistics/z-score/)
* [Amelia e Boruta](https://www.datacamp.com/community/tutorials/feature-selection-R-boruta)
* [CRAN’s New Missing Data Task View](https://rviews.rstudio.com/2018/10/26/cran-s-new-missing-values-task-view/)
* [Function that implements SMOTE (synthetic minority over-sampling technique)](https://www.rdocumentation.org/packages/unbalanced/versions/2.0/topics/ubSMOTE)
...
* [plumber - converte seu código R existente em uma API da Web](https://www.rplumber.io/)
* [testthat](https://www.tidyverse.org/articles/2017/12/testthat-2-0-0/) e [livro do hadley para isso](http://r-pkgs.had.co.nz/tests.html)
* [Top 20 R Libraries for Data Science in 2018 [Infographic]](https://medium.com/activewizards-machine-learning-company/top-20-r-libraries-for-data-science-in-2018-infographic-956f8419f883)
* [Bibliotecas de Data Science em Python, R e Scala](http://www.cienciaedados.com/bibliotecas-de-data-science-em-python-r-e-scala/)
* [cronR - Agendar scripts/processes](https://cran.r-project.org/web/packages/cronR/vignettes/cronR.html)
* [mlr: Machine Learning in R](https://mlr-org.github.io/mlr/articles/mlr.html) e      [MlrCheatsheet](https://github.com/mlr-org/mlr/blob/master/vignettes/tutorial/cheatsheet/MlrCheatsheet.pdf)
* [data.table](https://cran.r-project.org/web/packages/data.table/vignettes/datatable-intro.html)
* [TIBBLETIME](http://www.business-science.io/code-tools/2018/01/04/tibbletime-0-1-0.html)
* [purrr tutorial](https://jennybc.github.io/purrr-tutorial/)
* [modelDown: um gerador de website para seus modelos preditivos](http://smarterpoland.pl/index.php/2018/06/modeldown-a-website-generator-for-your-predictive-models/)
* [BETS](https://github.com/nmecsys/BETS)
* [DBPLRY](http://dbplyr.tidyverse.org/)
* [googleLanguageR](https://cran.r-project.org/web/packages/googleLanguageR/vignettes/setup.html)
* [future.apply – Parallelize Any Base R Apply Function](https://www.r-bloggers.com/future-apply-parallelize-any-base-r-apply-function/amp/)
* [imager](https://github.com/dahtah/imager)
* [poweRlaw](https://github.com/csgillespie/powerlaw)
* [janitor](https://github.com/sfirke/janitor)
* [gamlss - Generalized Additive Models for Location, Scale and Shape](http://www.gamlss.com/)
* [yardstick is a package to estimate how well models are working](https://github.com/tidymodels/yardstick)
...
* [Conteúdo para aprender RMarkdown](https://github.com/lhmet/adar-ufsm/blob/master/Rmarkdown.md)
* [Template pretydoc](https://github.com/yixuan/prettydoc)
* [Template rticles](https://github.com/rstudio/rticles)
* [Steve's R Markdown Templates](https://github.com/svmiller/svm-r-markdown-templates)
* [Citação style languages](https://github.com/citation-style-language/styles)
* [Rmarkdown templates](http://jianghao.wang/post/2017-12-08-rmarkdown-templates/)
* [Modelo-LaTeX-IFSul](https://github.com/Prof-Rodrigo-Silva/Modelo-LaTeX-IFSul)
...
* [Template para formatação de Tese da ESALQ em Rnw](https://github.com/fernandomayer/ESALQ-Tese-Template)
* [Templates for R Markdown](http://jianghao.wang/post/2017-12-08-rmarkdown-templates/)
...
* [Building a Daily Bitcoin Price Tracker with Coindeskr and Shiny in R](https://www.r-bloggers.com/building-a-daily-bitcoin-price-tracker-with-coindeskr-and-shiny-in-r/)
* [Como monitorar o uso do aplicativo no Shiny Server Open Source](http://www.rcharlie.com/post/shiny-monitor/)
* [RINNO: FULL STACK DATA SCIENCE MEETUP](https://rpubs.com/Dripdrop12/RInno)
* [Shiny Template](https://github.com/SESYNC-ci/shiny-template)
* [Show me Shiny - SQL CONNECTION](https://www.showmeshiny.com/sql-connection/)
* [shinyjqui - jQuery - UI Interactions and Effects for Shiny](https://github.com/Yang-Tang/shinyjqui)
* [shinyWidgets : Extend widgets available in shiny](https://dreamrs.github.io/shinyWidgets/)
...
* [Semantic dashboard - new open source R Shiny package](https://appsilondatascience.com/blog/rstats/2018/04/23/semanticdashboard.html)
...
* [Streaming Data](https://rviews.rstudio.com/2017/11/15/shiny-and-scheduled-data-r/)
* [Current Time](http://shiny.rstudio.com/gallery/current-time.html)
* [AdminLTE - shiny widgets examples](https://adminlte.io/themes/AdminLTE/index.html)
* [Awesome dashbords](https://divadnojnarg.github.io/blog/awesomedashboards/)
* [Dashboardthemes](https://github.com/nik01010/dashboardthemes)
* [Three R Shiny tricks to make your Shiny app shines (1/3)](https://antoineguillot.wordpress.com/2017/02/15/three-r-shiny-tricks-to-make-your-shiny-app-shines-13/)
...
* [Three R Shiny tricks to make your Shiny app shines (3/3): Buttons to delete, edit and compare Datatable rows](http://enhancedatascience.com/2017/03/01/three-r-shiny-tricks-to-make-your-shiny-app-shines-33-buttons-to-delete-edit-and-compare-datatable-rows/)
...
* [github - dreamRs/shinyWidgets](https://github.com/dreamRs/shinyWidgets)
* [Shiny DND](https://github.com/ayayron/shinydnd)
* [Machine Learning Calculator: Bias/Variance Tradeoff - Model Fit Comparison.](https://moody.shinyapps.io/Machine_Learning_Calculator/)
* [Add more interactivity to interactive charts - manipulateWidget](https://github.com/rte-antares-rpackage/manipulateWidget)
...
* [dashboardthemes v1.0.1 - github - custom theme support for R Shinydashboard applications.](https://nik01010.wordpress.com/)
* [dashboardthemes v1.0.1 - Wordpress - ](https://github.com/gomesfellipe/dashboardthemes)
...
* [ShinyProxy - nova plataforma de código aberto para implantar app para empresa
ou organizações maiores.](https://www.r-bloggers.com/shinyproxy-1-1-1-released/amp/) 
* [Instalando ShinyServer no linux](https://github.com/jjesusfilho/myscripts/blob/master/studio_shiny)
* [ShinyProxy in a container](https://www.shinyproxy.io/shinyproxy-containers/)
* [Nosso modelo de pacote para criar um shinyapp pronto para produção](https://rtask.thinkr.fr/blog/our-shiny-template-to-design-a-prod-ready-app/)
* [Instalação do R, Rstudio-server, shiny-server, nginx, ssl e autenticação do usuário do shinyapp no Ubuntu 16.04.](https://gist.github.com/jjesusfilho/7b7001745cbb8f7b1ad36e7bfe5d43e8)
* [Using Cookie Based Authentication with Shiny](https://calligross.de/post/using-cookie-based-authentication-with-shiny/)
* [Apresentação Rodrigo Casa&Video - Shiny em produção](https://www.slideshare.net/RodrigoHartmann2/shiny-em-produo)
* [Adding Authentication to Shiny Server in 4 Simple Steps](https://auth0.com/blog/adding-authentication-to-shiny-server/)
* [Authentication and database - Shiny](https://shiny.rstudio.com/gallery/authentication-and-database.html)
* [nginx default public www location - StackOverFlow](https://stackoverflow.com/questions/10674867/nginx-default-public-www-location)
...
* [Data Visualization with Highcharter in R](https://www.datacamp.com/community/tutorials/data-visualization-highcharter-r)
...
* [Recipes for Data Processing](https://github.com/topepo/user2018/blob/master/slides/Recipes_for_Data_Processing.pdf)
...
* [O que é o pipe: `%>%` ?](http://material.curso-r.com/pipe/)
* [Pipe para R](https://gomesfellipe.github.io/post/2017-12-07-manipulando-dados-com-dplyr/manipulando-dados-com-dplyr/)
* [Pipe para Python](https://towardsdatascience.com/dplyr-style-data-manipulation-with-pipes-in-python-380dcb137000)
...
* [neuralnet: Train and Test Neural Networks Using R](https://www.r-bloggers.com/neuralnet-train-and-test-neural-networks-using-r/amp/)
...
* [Dicas de aprendizado profundo - MIT stanford.edu em PORTUGUES ](https://stanford.edu/~shervine/l/pt/teaching/cs-229/dicas-aprendizado-profundo)
* [Feedforward Deep Learning Models](http://uc-r.github.io/feedforward_DNN)
* [Deep Learning Book](http://deeplearningbook.com.br/)
* [Deep Learning with R - Keras and TensorFlow](https://datascienceplus.com/deep-learning-with-r/)
* [Image-to-image translation with pix2pix
Conditional GANs (cGANs)](https://blogs.rstudio.com/tensorflow/posts/2018-09-20-eager-pix2pix/?utm_content=bufferdbf70&utm_medium=social&utm_source=linkedin&utm_campaign=buffer)
* [A gentle introduction to OCR](https://towardsdatascience.com/a-gentle-introduction-to-ocr-ee1469a201aa)
* [Awesome Deep Learning links](https://github.com/gomesfellipe/awesome-deep-learning)
* [R vs Python: Image Classification with Keras](https://datascienceplus.com/r-vs-python-image-classification-with-keras/)
...
* [Deep Learning for the Masses (and The Semantic Layer)](https://towardsdatascience.com/deep-learning-for-the-masses-and-the-semantic-layer-f1db5e3ab94b)
...
* [THE TIDY TIME SERIES PLATFORM: TIBBLETIME 0.1.0](http://www.business-science.io/code-tools/2018/01/04/tibbletime-0-1-0.html)
* [Forecasting Using a Time Series Signature with timetk](https://business-science.github.io/timetk/articles/TK03_Forecasting_Using_Time_Series_Signature.html)
* [Análise e simulação de investimentos com o pacote calcCidadao](http://sillasgonzaga.com/post/analise-e-simulacao-de-investimentos-com-o-pacote-calccidadao/)
* [DEMO WEEK: TIDY TIME SERIES ANALYSIS WITH TIBBLETIME](http://www.business-science.io/code-tools/2017/10/26/demo_week_tibbletime.html)
* [TIBBLETIME](https://business-science.github.io/tibbletime/articles/TT-01-time-based-filtering.html#syntax)
...
* [Time Series Analysis using R](https://www.datacamp.com/community/tutorials/time-series-r)
* [arimax: Fitting an ARIMA model with Exogeneous Variables](https://rdrr.io/cran/TSA/man/arimax.html)
* [Time series shootout: ARIMA vs. LSTM (talk)](https://www.r-bloggers.com/time-series-shootout-arima-vs-lstm-talk/amp/)
* [Decomposition-Based Approaches to Time Series Forecasting](https://www.datascience.com/blog/decomposition-based-approaches-to-time-series-forecasting?hs_amp=true)
* [A Bayesian Approach to Time Series Forecasting](https://towardsdatascience.com/a-bayesian-approach-to-time-series-forecasting-d97dd4168cb7)
* [Everything you can do with a time series](https://www.kaggle.com/thebrownviking20/everything-you-can-do-with-a-time-series)
* [sweep: Extending broom for time series forecasting](https://www.business-science.io/code-tools/2017/07/09/sweep-0-1-0.html)
...
* [Dplyr and SQL](https://www.johnmackintosh.com/2018-06-01-dplyr-for-the-win/)
* [DBPLRY](http://dbplyr.tidyverse.org/)
* [artigo tidyverse sobre dbplyr ](http://dbplyr.tidyverse.org/articles/dbplyr.html)
* [SQL CONECTION](https://www.showmeshiny.com/sql-connection/)
...
* [WordCloud positive - negative words](http://www.michaeljgrogan.com/tidytext-word-clouds-sentiment-r/)
* [Mining twitter with R - Guia de Nuvem de Palavras](https://sites.google.com/site/miningtwitter/home)
* [Livro TextMining da Julia Silge](https://www.tidytextmining.com/)
* [Summarizing Web Articles with R using lexRankr](https://adamspannbauer.github.io/2017/12/17/summarizing-web-articles-with-r/)
* [Tidy Sentiment Analysis in R](https://www.datacamp.com/community/tutorials/sentiment-analysis-R?utm_campaign=News&utm_medium=Community&utm_source=DataCamp.com)
* [Word2vec baby step in deep learning but leap towards NLP](https://towardsdatascience.com/word2vec-a-baby-step-in-deep-learning-but-a-giant-leap-towards-natural-language-processing-40fe4e8602ba)
* [Analise sentimentos com dados do spotify](http://www.rcharlie.com/post/fitter-happier/)
* [What is sentiment analysis](https://www.crimsonhexagon.com/blog/what-is-sentiment-analysis/)
* [googleLanguageR](https://cran.r-project.org/web/packages/googleLanguageR/vignettes/setup.html)
* [Conectando R com o Twitter parte 1](https://medium.com/meumesmo/conectando-o-r-com-o-twitter-parte-1-instalando-788610a0f8aa)
* [A guide to working with character data in R](https://www.r-bloggers.com/a-guide-to-working-with-character-data-in-r/amp/) 
...
* [Introduction to googleLanguageR](https://cran.r-project.org/web/packages/googleLanguageR/vignettes/setup.html)
* [crfsuite for natural language processing](http://www.bnosac.be/index.php/blog/83-crfsuite-for-natural-language-processing)
* [remove emoji from string in R](https://stackoverflow.com/questions/38215590/remove-emoji-from-string-in-r)
* [qdapRegex is a collection of regex tools ](http://trinker.github.io/qdapRegex/)
* [function `rm_emoticon()`: Remove/Replace/Extract Emoticons](https://rdrr.io/cran/qdapRegex/man/rm_emoticon.html)
* [Emoticons decoder for social media sentiment analysis in R](http://opiateforthemass.es/articles/emoticons-in-R/)
* [Practicing sentiment analysis with Harry Potter](https://cfss.uchicago.edu/text003_harry_potter_exercise.html)
* [ASSOCIAÇÕES DE PALAVRAS DO SMALL WORLD OF WORDS - (AED e GLM)](https://juliasilge.com/blog/word-associations/)
* [TENSORFLOW, JANE AUSTEN, AND TEXT GENERATION](https://juliasilge.com/blog/tensorflow-generation/)
* [TRAINING, EVALUATING, AND INTERPRETING TOPIC MODELS](https://juliasilge.com/blog/evaluating-stm/)
* [markovifyR - gerador de texto com cadeias de markov](https://github.com/abresler/markovifyR)
...
* [1 - THE GAME IS AFOOT! TOPIC MODELING OF SHERLOCK HOLMES STORIES](https://juliasilge.com/blog/sherlock-holmes-stm/)
* [2 - TRAINING, EVALUATING, AND INTERPRETING TOPIC MODELS
](https://juliasilge.com/blog/evaluating-stm/)
* [A Shiny Application for Structural Topic Models](https://cschwem2er.github.io/stminsights/)
* [Optimizing semantic coherence in topic models](https://dl.acm.org/citation.cfm?id=2145462)
